...
public class WxUserOrgPusher extends BasePusher {
    ...
    private void wxMsgPush(ClTradeOrg org,ClClue clClue){
        ...
        System.out.printf("机构%d，%s 线过%d，%s",org.getOid(),org.getOname(),clClue.getClId(),clClue.getClDesc());
    }
