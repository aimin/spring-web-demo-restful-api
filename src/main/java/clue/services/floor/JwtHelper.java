...
public class JwtHelper {
    ...
    public static String createJWT(Map<String, Object> claims, Long time) {
        ...
        JwtBuilder builder;//设置签名使用的签名算法和签名使用的秘钥
        builder = (JwtBuilder) Jwts.builder() //这里其实就是new一个JwtBuilder，设置jwt的body
...
//        map.put("openId", openId);
     ...
     * 根据userId和openid生成token
     */
    public static String generateToken(Map<String,Object> map,long expiredTime) {
        return createJWT(map, expiredTime);
    }
